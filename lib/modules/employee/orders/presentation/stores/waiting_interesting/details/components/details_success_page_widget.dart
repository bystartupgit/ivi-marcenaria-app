...
class AprovalProposalSuccessPage extends StatelessWidget {
  ...
  final String subtitle = "O suporte está finalizando os últimos detalhes com o cliente. "
        ...
        body: Container(
          ...
          child: Column(
              ...
              children: [
                ...
                SizedBox(width: MediaQuery.of(context).size.width * 0.45, child: ConfirmationButtonWidget(title: buttonTitle, size: 12,
