...
class NotificationDataSource {
  ...
  Future<List<NotificationEntity>> getNotifications({required int userID, required int page, required int limit }) async {
    ...
    if(response.statusCode == 200) {
      ...
      if(notifications.isNotEmpty) { return notifications.map((e) => NotificationEntity.fromMap(e)).toList(); }
      else { return []; }
