        ...
        child: Column(
          ...
          children: [
            ...
            NavigationDrawerOptionWidget(icon: DrawerIcons.notification, onPressed: () {
              ...
              Modular.to.pushNamed(RouterGlobalMapper.notification); }, title: HomeTitleMapper.notification),
            ...
            NavigationDrawerOptionWidget(icon: DrawerIcons.calculator, onPressed: () {
              Navigator.pop(context);
              store.setIndex(1);
            }, title: HomeTitleMapper.orcamentos),
            NavigationDrawerOptionWidget(icon: DrawerIcons.document, onPressed: () {
              Navigator.pop(context);
              store.setIndex(2);
            ...
            NavigationDrawerOptionWidget(icon: DrawerIcons.user,
                onPressed: () {
                  Navigator.pop(context);
                  Modular.to.pushNamed(CustomerRouters.profileIntern); }, title: HomeTitleMapper.profile),
