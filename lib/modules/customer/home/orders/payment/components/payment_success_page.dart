...
class PaymentSuccessPage extends StatelessWidget {
  ...
  final String subtitle = "Enviaremos o link de pagamento por e-mail. Assim que o pagamento for confirmado, você será notificado,"
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          InkWell(
            onTap: () => Modular.to.popUntil(ModalRoute.withName(Modular.initialRoute)),
            child: Container(
                ...
                child: Row(
                    ...
                    children: [
                      ...
                      Text(buttonTitle,style: TextStyle(color: Colors.white,fontFamily: FamilyTheme.medium,fontSize: 14))
                    ]
                )),
          ),
