              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Titulo do Serviço",style: TextStyle(fontFamily: FamilyTheme.mediumItalic, color: Colors.black, fontSize: 20)),
                        DetailsRichWidget(title: title, description: "Numero do Serviço"),
                        DetailsRichWidget(title: environment, description: "Ambientes do Serviço"),
                      ]))
                ]))
