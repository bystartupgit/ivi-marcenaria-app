...
class SavePotentialEmployeeUsecase {
  ...
  Future<bool> call ({required List<int> employeeIDs, required int proposalID }) async =>
      datasource.savePotentialEmployees(employeeIDs: employeeIDs, proposalID: proposalID);
