                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: AnimatedTextKit(
                            repeatForever: true,
                            animatedTexts: [
                              FadeAnimatedText(OnboardingMapper.oc1, textStyle: TextStyle(fontSize: 36,fontFamily: FamilyTheme.medium,color: Colors.white)),
                              FadeAnimatedText(OnboardingMapper.oc2, textStyle: TextStyle(fontSize: 36,fontFamily: FamilyTheme.medium,color: Colors.white)),
                              FadeAnimatedText(OnboardingMapper.oc3, textStyle: TextStyle(fontSize: 36,fontFamily: FamilyTheme.medium,color: Colors.white)),
                            ]),
                      ),
