...
class SaveEmployeeProposalUseCase {
  ...
  Future<(String,bool)> call ({required int proposalID, required int employeeID }) async =>
      datasource.selectionEmployeeToExecution(proposalID: proposalID, employeeID: employeeID);
