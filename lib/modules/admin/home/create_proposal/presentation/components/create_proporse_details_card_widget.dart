...
import 'details_complete_widget.dart';
import 'details_incomplete_widget.dart';

class CreateProporseDetailsCardWidget extends StatelessWidget {

  final bool moreDetails;
  final Function() changeMoreDetails;

  final OrderWithoutProposalEntity order;

  final String title = "Orçamento Nº";
  final String image = "assets/home/covers/1.jpeg";

  const CreateProporseDetailsCardWidget({super.key, required this.order, required this.changeMoreDetails, required this.moreDetails});
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    AnimatedContainer(
                        ...
                        child: moreDetails ?
                        DetailsCompleteWidget(order: order, lessDetails: () => changeMoreDetails()) :
