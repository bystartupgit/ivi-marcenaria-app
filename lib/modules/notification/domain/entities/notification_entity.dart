...
class NotificationEntity {
  ...
  NotificationEntity({
    required this.id, required this.message, required this.type,
  ...
  NotificationEntity readNotification() =>
      NotificationEntity(id: id, message: message, type: type, isRead: true, date: date);

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is NotificationEntity) { return id == other.id; }
    return false;
  }
