...
class EmployeeUserEntity {
  ...
  factory EmployeeUserEntity.fromMapWithInteresting(
          Map<String, dynamic> map, String interesting) =>
      EmployeeUserEntity(
          ...
          funcoes: map[EmployeeUserMapper.funcoes] == null
              ? <String>[]
              : List<String>.from(map[EmployeeUserMapper.funcoes]),
          ...
          name: map[EmployeeUserMapper.user]?[EmployeeUserMapper.name] ??
              "Nome Prestador");
  ...
  bool operator ==(Object other) {
    ...
    if (other is EmployeeUserEntity) {
