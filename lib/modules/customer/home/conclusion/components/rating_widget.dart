...
class RatingWidget extends StatelessWidget {
  ...
  const RatingWidget({super.key,
    ...
    required this.title, required this.hint, required this.label});
  ...
  Widget build(BuildContext context) {
    return Column(
      spacing: 20.0,
        children: [
          Text(title,style: TextStyle(color: ColorTheme.black3,fontFamily: FamilyTheme.regular,fontSize: 18)),
          StarRating(
          ...
          Column(
            ...
            spacing: 5.0,
            children: [
              Text(label,style: TextStyle(color: ColorTheme.black3, fontFamily: FamilyTheme.regular,fontSize: 12)),
              Container(
                      ...
                      children: [
                        TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintStyle: TextStyle(fontFamily: FamilyTheme.regular,color: ColorTheme.black,fontSize: 10),
                                counter: const Text(""),
