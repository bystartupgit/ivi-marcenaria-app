                ...
                mainAxisSize: MainAxisSize.min,
                  ...
                  children: [
                    ...
                    Text(subtitle, textAlign: TextAlign.center,
                        style: TextStyle(fontFamily: FamilyTheme.light,
                    ...
                    Container(
                        ...
                        child: EmailTextFieldWidget(title: "E-mail", icon: LoginIcons.email, onChanged: store.setEmail)),
                    const SizedBox(height: 40.0),
                    ElevatedButton(
                        onPressed: store.emailNotEmpty ? () => store.sendEmailReset(context: context) : null,
