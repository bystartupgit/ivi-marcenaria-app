...
class OrderListWidget extends StatelessWidget {
  ...
  const OrderListWidget({super.key, required this.orders, required this.message, required this.details});
        ...
        child: Column(
          children: [
            ListView.separated(
                ...
                itemBuilder: (context,index) => OrderCardWidget(order: orders[index],details: details)),
