...
import 'package:marcenaria/modules/customer/home/profile/form/presentation/components/profile_edit_image_widget.dart';
...
class ProfileFormPage extends StatefulWidget {
  ...
  const ProfileFormPage({super.key, required this.profile});
              ...
              body: SingleChildScrollView(
                  child: Container(
                      ...
                      child: Column(
                          spacing: 10.0,
                          children: [
                            ProfileEditImageWidget(name: store.name.text,pathImage: store.pathImage, uploadImage: () =>
                                store.uploadImage(context: context, id: widget.profile.userID), image: store.image),
                            ...
                            ProfileUpdateButtonWidget(onPress: () => store.update(context: context,id: widget.profile.userID))
