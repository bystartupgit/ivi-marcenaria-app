...
class RouterMapper {
  ...
  static String confirmPassword = "/ResetPassword/Code/ConfirmPassword/";

  static String documentIntern = "Document/";
  static String contractIntern = "Contract/";
  static String registerIntern = "Register/";
  static String successIntern = "Success/";
