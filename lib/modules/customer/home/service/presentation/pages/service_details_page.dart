          ...
          SingleChildScrollView(
            child: Column(
                ...
                children: [
                  ...
                  ServiceObservationWidget(onChanged: store.setObservations,
                      setWhatsapp: store.setWhatsApp, whatsapp: store.whatsapp),
                  const SizedBox(height: 10.0),
                  ServiceCoverSelectorWidget(store: store),
                  const SizedBox(height: 30.0),
                  ServiceConclusionButtonWidget(onPressed: () => store.saveService(context: context)),
