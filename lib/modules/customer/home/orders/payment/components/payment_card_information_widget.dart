...
class PaymentCardInformationWidget extends StatelessWidget {
  ...
  const PaymentCardInformationWidget({super.key,
    required this.onPressed,
    required this.hasOption, required this.option, required this.setOption});
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: TextStyle(fontFamily: FamilyTheme.medium,
                color: ColorTheme.black3, fontSize: 18,)),
              Text(subtitle, style: TextStyle(fontFamily: FamilyTheme.light,
                color: ColorTheme.black3, fontSize: 12,)),
              ListTile(
                contentPadding: EdgeInsets.zero,
                horizontalTitleGap: 0,
                title: Text('A vista - PIX',style: TextStyle(fontFamily: FamilyTheme.regular,
                  color: ColorTheme.black3, fontSize: 12,)),
                leading: Radio<int>(
              ...
              Center(child: PaymentFinishButtonWidget(onPressed: hasOption? onPressed : null))
