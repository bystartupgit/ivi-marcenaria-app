class RouterMapper {
  ...
  static String choiceEmployeeDetails = "/ChoiceEmployeeDetails/";
  static String waitingEmployeeDetails = "/WaitingEmployeeDetails/";
  static String productionOrderDetails = "/ProductionOrderDetails/";
  static String conclusionOrderDetails = "/ConclusionOrderDetails/";

  static String customer = "/Customer/";
  static String customerProfile = "/Customer/Profile/";
  static String customerProfileForm = "/Customer/Profile/Form/";
  ...
  static String orderSuccessIntern = "OrderSuccess/";
}
