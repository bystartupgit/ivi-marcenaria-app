...
class ServiceTypeWidget extends StatelessWidget {
  ...
  final String description = "Anexe imagens ou PDF do projeto fornecendo o máximo de informações para que elaboremos o seu orçamento.";

  final String title2 = "Sua ideia ou referencia é?";
  final String description2 = "Esta informação nos ajuda entender as imagens anexadas.";
        ...
        child: Column(
            ...
            children: [
              ...
              Text(title2, style: TextStyle(fontSize: 18,
                  ...
                  fontFamily: FamilyTheme.bold)),
              const SizedBox(height: 2.0),
              Text(description2, style: TextStyle(fontSize: 12,
                  color: ColorTheme.title,
                  fontFamily: FamilyTheme.regular)),
