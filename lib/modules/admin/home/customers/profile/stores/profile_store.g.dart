...
mixin _$ProfileStore on ProfileStoreBase, Store {
  late final _$quantityAtom =
      Atom(name: 'ProfileStoreBase.quantity', context: context);

  @override
  CustomerQuantityEntity get quantity {
    _$quantityAtom.reportRead();
    return super.quantity;
  }

  @override
  set quantity(CustomerQuantityEntity value) {
  ...
  late final _$ordersAtom =
      Atom(name: 'ProfileStoreBase.orders', context: context);
  ...
  @override
  Future uploadImage(
      {required dynamic context, required CustomerUserEntity customer}) {
    return _$uploadImageAsyncAction
        .run(() => super.uploadImage(context: context, customer: customer));
  }
