...
class HomeProposalWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
        ...
        children: [
          Text(title,textAlign: TextAlign.start,style: TextStyle(fontSize: 14,color: ColorTheme.black3,fontFamily: FamilyTheme.medium)),
          ...
          Text(register,textAlign: TextAlign.start,style: TextStyle(fontSize: 14,color: ColorTheme.black3,fontFamily: FamilyTheme.medium)),
          HomeCardWidget(title: customer,onPressed: () => Modular.to.pushNamed(RouterMapper.customerIntern),icon: DrawerIcons.user),
          const SizedBox(height: 10.0),
