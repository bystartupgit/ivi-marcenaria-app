    ...
    return Observer(
      builder: (context) => SizedBox(
        ...
        child: CustomSlidingSegmentedControl<int>(customSegmentSettings: CustomSegmentSettings(),
          ...
          children: {
            1 : Text("Ag. Prestadores",style: TextStyle(
            ...
            2 : Text("Escolher Prest.", style: TextStyle(
            ...
            3 : Text("Em Produção", style: TextStyle(
                color: store.index ==  3 ? ColorTheme.orange : ColorTheme.inactivate, fontSize: 10,
                fontFamily: store.index ==  3 ? FamilyTheme.bold : FamilyTheme.regular)),
          },
        ),
      ),
    );
