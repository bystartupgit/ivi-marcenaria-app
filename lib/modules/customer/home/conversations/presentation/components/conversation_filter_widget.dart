...
class ConversationFilterWidget extends StatelessWidget {
  ...
  const ConversationFilterWidget({ super.key, required this.onChanged, required this.name });
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(
            ...
            children: [
              Text("${name.split(" ").first} $title",style: TextStyle(fontSize: 16,color: ColorTheme.title,fontFamily: FamilyTheme.bold)),
