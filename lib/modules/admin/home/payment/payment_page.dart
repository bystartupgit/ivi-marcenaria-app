        ...
        child: Scaffold(
            ...
            body: store.loading ? Center(child: CircularProgressIndicator(color: ColorTheme.orange)) : Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                    children: [
                      CreateProporseDetailsCardWidget(order: store.order!, moreDetails: store.moreDetails,
                          ...
                          children: [
                            Expanded(
                              child: CreateProporseCustomerButtonWidget(size: 12, onPressed: () =>
                                  ...
                                  OrderEntity(id: widget.orderID, title: store.order?.title ?? "",
                                      environments: store.order?.environments ?? "", status: store.order?.status ?? OrderStatus.aproval ))
                              ),
                            ),
                          ]),
