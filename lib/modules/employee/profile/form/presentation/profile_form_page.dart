...
import 'package:marcenaria/modules/employee/profile/form/presentation/components/profile_position_widget.dart';
...
import 'components/profile_document_widget.dart';
import 'components/profile_edit_field_widget.dart';
import 'components/profile_edit_image_widget.dart';
import 'components/profile_update_button_widget.dart';
                  ...
                  child: Container(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            ProfilePositionWidget(jobs: store.jobs,store: store),
                            ProfileDocumentWidget(title: "Carteira de trabalho",icon: ProfileIcons.documents,
                                onPressed: () => store.getDocumentPhoto(context: context),
                                files: store.workDocument == null ? [] : [store.workDocument]),
                            ProfileDocumentWidget(title: "Imagens marcenaria",icon: ProfileIcons.images,
                                onPressed: () => store.getMarcenariaPhoto(context: context),
                                files: store.marcenaria.isEmpty ? [] : store.marcenaria),
