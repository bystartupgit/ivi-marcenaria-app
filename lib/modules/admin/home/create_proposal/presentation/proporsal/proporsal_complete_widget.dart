          ...
          child:
            ...
            if (store.temporal == "SIM")
              Text("Preço por tempo Limitado!",
                  style: TextStyle(
                      ...
                      color: Colors.red,
                      fontSize: 12)),
            if (dto.valueParcel != null)
              Text(
                  "ou entrada + Parcelado: 1x ${"R\$ ${store.formatValues(dto.openingValue ?? 0)}"} + ${dto.parcels}x ${"R\$ ${store.formatValues(dto.valueParcel!)}"}",
                  style: TextStyle(
                      fontFamily: FamilyTheme.regular,
                      color: Colors.black,
                      fontSize: 10)),
            ...
            Text(dto.message,
                ...
                style: TextStyle(
                    ...
                    fontSize: 14)),
            const SizedBox(height: 10.0),
            ProposalRichTitleWidget(
                total: "R\$ ${store.formatValues(dto.totalValue)}"),
            Center(
              child: InkWell(
                onTap: lessDetails,
                child: Column(
