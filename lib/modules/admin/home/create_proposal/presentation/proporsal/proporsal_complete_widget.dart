                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if(dto.fromTo != null) Text(store.formatValues(dto.totalValue), style: TextStyle(fontFamily: FamilyTheme.regular, color: Colors.black, fontSize: 10,decoration: TextDecoration.lineThrough)),
                    ],
                  ),
                  Row(
                    spacing: 10.0,
                  ...
                  Text("Preço por tempo Limitado!", style: TextStyle(fontFamily: FamilyTheme.medium, color: Colors.red, fontSize: 12)),
