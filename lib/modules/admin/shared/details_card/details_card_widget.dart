...
class DetailsCardWidget extends StatefulWidget {
  ...
  const DetailsCardWidget({super.key, required this.order, this.status, this.statusColor});
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    AnimatedContainer(
                        ...
                        child: moreDetails ?
                        DetailsCompleteWidget(order: order,
                            status: widget.status,
                            statusColor: widget.statusColor,
                            lessDetails: () => changeMoreDetails()) :
                        DetailsIncompleteWidget(order: order,
                            status: widget.status,
                            statusColor: widget.statusColor,
