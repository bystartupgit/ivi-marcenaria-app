        ...
        builder: (_) => ModalProgressHUD(
              ...
              child: Scaffold(
                  ...
                  appBar: AppBar(
                      ...
                      leading: IconButton(
                          onPressed: () => Modular.to.pop(store.profile),
                  ...
                  body: SingleChildScrollView(
                      child: Container(
                          ...
                          child: Column(spacing: 10.0, children: [
                            ...
                            ProfilePositionWidget(
                                jobs: store.jobs, store: store),
                            ProfileDocumentWidget(
                                title: "Carteira de trabalho",
                                icon: ProfileIcons.documents,
                                onPressed: () =>
                                    store.getDocumentPhoto(context: context),
                                files: store.workDocument == null
                                    ? []
                                    : [store.workDocument]),
                            ProfileDocumentWidget(
                                title: "Imagens marcenaria",
                                icon: ProfileIcons.images,
                                onPressed: () =>
                                    store.getMarcenariaPhoto(context: context),
                                files: store.marcenaria.isEmpty
                                    ? []
                                    : store.marcenaria),
                            const SizedBox(height: 30.0),
                            ProfileUpdateButtonWidget(
                                onPress: () => store.update(context: context)),
                            const SizedBox(height: 30.0),
                          ])))),
            ));
  }
